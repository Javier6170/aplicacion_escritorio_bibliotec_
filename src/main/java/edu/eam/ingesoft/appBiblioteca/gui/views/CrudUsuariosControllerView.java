...
import edu.eam.ingesoft.appBiblioteca.gui.controller.CrudUsuarioController;
 ...
 * @author Javier
 */
public class CrudUsuariosControllerView extends javax.swing.JFrame {

    CrudUsuarioController controlador;
    public CrudUsuariosControllerView() {
        initComponents();
        controlador = new CrudUsuarioController();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            controlador.createLibro(txtUserIdentification.getText(), txtApellido.getText(), txtNombre.getText());
        } catch (Exception ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrudUsuariosControllerView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CrudUsuariosControllerView().setVisible(true);
            }
        });
    }
